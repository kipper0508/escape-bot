import { extractAllGamesList, extractGamesInLoacation, getCustomerComment } from '../services/searchEscapeBar.js';
...
async function main() {
    ...
    const comment = await getCustomerComment(gamesInLocation[0].gameId);
    console.log(comment);
}
